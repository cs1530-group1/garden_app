...
//*************************************************************************************************************
    ...
    //format for the string representation of the garden-> #species:speciesName:speciesDescription:speciesType (ex: annual(0), perenial(1), tree(2)):speciesPlantDate:speciesPruneDate:speciesSunLevel:speciesColor:speciesSize:data for next species:#plants:plantx:planty:plantSpecies:data for next plant	
    static String gardenToString(Garden g);
    static Garden stringToGarden(String g);
    ...
    boolean setType(String speciesName,int speciesType); //the species type will be 0 for annual, 1 for perennial, and 2 for tree
    ...
    int getType(String speciesName); //the species type will be 0 for annual, 1 for perennial, and 2 for tree
